...
import { salvarEvento } from "../hooks/localStorageConexao";

export default function NovoEvento() {
    const [nome, setNome] = useState('')
    const [situacao, setSituacao] = useState<'Aberto' | 'Finalizado' | 'Expirado'>('Aberto')
    const [data, setData] = useState('')
    const [recorrencia, setRecorrencia] = useState<'Diária' | 'Semanal' | 'Mensal' | 'Não Repete'>('Não Repete')
    ...
    function salvarRetornar(e:FormEvent){
        e.preventDefault()
        const evento = { nome: nome, situacao: situacao, data: data, 
